	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'glass-gradient': 'linear-gradient(135deg, rgba(248,250,252,0.1) 0%, rgba(248,250,252,0.05) 100%)',
				'nova-gradient': 'linear-gradient(90deg, #6366F1 0%, #A855F7 50%, #EC4899 100%)'
			},
			backdropBlur: {
				'xs': '2px',
			}
